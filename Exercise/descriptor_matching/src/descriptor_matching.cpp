                      ...
                      vector<cv::DMatch> &matches, string descriptorType, string matcherType, string selectorType)
{
    ...
    // FLANN method (fast library for approximate nearest neighbors)
    ...
    { 
        ...
        double t = (double)cv::getTickCount();
        // TODO : Implement k-nearest-neighbor matching with the two best matches
...
int main()
{
    ...
    // Select fast library for approximate nearest neighbors (FLANN)
